...
public class ContactsAdapter extends ArrayAdapter<Contact> {
    ...
    public ContactsAdapter(Context context, int layoutResourceId, Contact[] data) {
        ...
        Log.d("PAYBACK:CONTACTSADAPTER: ", "Entered constructor of ContactsAdapter");

        this.context = context;
        this.layoutResourceId = layoutResourceId;
        this.data = data;

        Log.d("PAYBACK:CONTACTSADAPTER: ", "Exited constructor of ContactsAdapter");
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(row == null) {
            ...
            holder.icon = (ImageView)row.findViewById(R.id.imgView_Contact_Icon);
            holder.txtName = (TextView)row.findViewById(R.id.txtView_Contact_Name);
            holder.txtContactInfo = (TextView)row.findViewById(R.id.txtView_Contact_ContactMethod);
        ...
        Log.d("PAYBACK:CONTACTSADAPTER: ", "Exited if block of getView of ContactsAdapter");
